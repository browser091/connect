const store = {
    ...
    addMesageState(newMesage) {
        let tempMesage = {
            id: "6",
            mesage: newMesage,
        };
        this.state.dialogsPage.mesages.push(tempMesage);
        console.log(this.state.dialogsPage.mesages);
        this.rerender();
    },

    updateMessage(newText) {
        // debugger;
        this.state.dialogsPage.addNewMessage = newText;
        this.rerender();
    },
    subscribe(observer) {
